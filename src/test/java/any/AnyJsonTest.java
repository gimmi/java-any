...
public class AnyJsonTest {
	...
	public void should_parse_complex_json() {
        ...
        assertThat(any.size()).isEqualTo(9);
        ...
        assertThat(any.get("nullProp").size()).isZero();
        assertThat(any.get("emptyAry").size()).isZero();
        assertThat(any.get("emptyObj").size()).isZero();
        ...
        assertThat(any.get("aryProp").get(5).size()).isZero();
        assertThat(any.get("aryProp").get(6).size()).isZero();
        assertThat(any.get("objProp").size()).isEqualTo(7);
        ...
        assertThat(any.get("objProp").get("emptyAry").size()).isZero();
        assertThat(any.get("objProp").get("emptyObj").size()).isZero();
	}
